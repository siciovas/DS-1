...
//        checkCarMarketSorting();
    ...
    void createCarList() {
        System.out.println("ITERATORIUS");
        Car a1 = new Car("Renault", "Laguna", 1997, 50000, 1700);
        Car a2 = new Car("Renault", "Megane", 2001, 20000, 3500);
        Car a3 = new Car("Toyota", "Corolla", 2001, 20000, 8500.8);
        cars.add(a1);cars.add(a2);cars.add(a3);
